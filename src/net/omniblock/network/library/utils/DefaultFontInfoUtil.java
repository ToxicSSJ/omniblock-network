...
public enum DefaultFontInfoUtil {
	...
	DefaultFontInfoUtil(char character, int length) {
	...
	public int getBoldLength() {
		if (this == DefaultFontInfoUtil.SPACE)
			return this.getLength();
		return this.length + 1;
	}

	public static DefaultFontInfoUtil getDefaultFontInfo(char c) {
		for (DefaultFontInfoUtil dFI : DefaultFontInfoUtil.values()) {
			if (dFI.getCharacter() == c)
				return dFI;
		}
		return DefaultFontInfoUtil.DEFAULT;
	}
