...
public class ItemBuilder {
	...
	/**
	 * Initalizes the ItemBuilder with {@link org.bukkit.Material} and
	 * Displayname
	 */
	 ...
	 * @param path
	 *            Path to which the ConfigStack should be writed
	 */
	 ...
	 * @param path
	 *            Path from which the ConfigStack should be read
	 */
	 ...
	 *            Path to which the ConfigStack should be writed
	 * @param builder
	 *            Which ItemBuilder should be writed
	 */
	 ...
	 * @param overwrite
	 *            Should the JsonItemBuilder used now
	 */
	...
	public class Unsafe {
		...
		/**
		 * This Class contains highly sensitive NMS Code that should not be
