package net.omniblock.network.library.helpers.bossbar.nms;

import org.bukkit.Location;

import net.omniblock.network.library.helpers.bossbar.Util;
...
public class v1_8Fake extends FakeDragon {
	...
	public static boolean isUsable() {
		...
		try {
			PacketPlayOutEntityTeleport.getConstructor(new Class<?>[] { int.class, int.class, int.class, int.class,
