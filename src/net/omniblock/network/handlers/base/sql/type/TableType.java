...
public enum TableType {
	...
	SURVIVAL_BANK_DATA("survival_bank_data", "CREATE TABLE IF NOT EXISTS survival_bank_data (id INT PRIMARY KEY AUTO_INCREMENT, p_id TEXT(20) NOT NULL, p_money TEXT(20) NOT NULL )", "INSERT INTO survival_bank_data (p_id, p_money) SELECT * FROM (SELECT VAR_P_ID a, 0 b) AS tmp WHERE NOT EXISTS (SELECT 1 FROM survival_bank_data WHERE p_id = VAR_P_ID );", true, false),
