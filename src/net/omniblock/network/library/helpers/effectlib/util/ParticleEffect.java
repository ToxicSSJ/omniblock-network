...
import net.omniblock.network.library.helpers.effectlib.util.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	 ...
	 */
	@Deprecated
	public void display(ParticleData data, Location center, double range, float offsetX, float offsetY, float offsetZ,
