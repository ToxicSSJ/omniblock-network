...
/**
 * Animation types that can be displayed on an npc. Removed LEAVE_BED animation
 * as it didn't do what lenis0012 thought it did. Redundant animation, therefore
 * removed.
 *
 * @author lenis0012
 */
