package net.omniblock.network.library.helpers.npc.api;
...
public interface NPC {
	...
	/**
	 * == !!DEPRECATED!! == Use {@link #isCollisionEnabled() isCollisionEnabled}
	 * method instead.
	 */
	@Deprecated
	...
	/**
	 * == !!DEPRECATED!! == Use {@link #setCollisionEnabled(boolean)
	 * setCollisionEnabled} method instead.
	 */
	@Deprecated
	 ...
	 *            Whether or not collision with entities is enabled
	 */
